    ...
    try:
        ...
        try:
            play = await mb_request(
                "GET",
                f"/wefeed-mobile-bff/subject-api/play-info?subjectId={subject_id}&se={se}&ep={ep}",
            )
...
async def catalog_stream(
    ...
    if subject_id:
        try:
            play = await mb_request(
                "GET",
                f"/wefeed-mobile-bff/subject-api/play-info?subjectId={subject_id}&se={se if media=='tv' else 0}&ep={ep if media=='tv' else 0}",
            )

...
async function animePlayStream(slug, idx){
  ...
  try{
    ...
    const playUrl=(/\.m3u8(\?|$)/i.test(url))?('/anime/hls?u='+encodeURIComponent(url)):url;
    box.innerHTML=`<video id="av" playsinline crossorigin="anonymous" style="width:100%;aspect-ratio:16/9;background:#000;display:block"></video>`;

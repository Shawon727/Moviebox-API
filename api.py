...
# =============================================================================
# Frontend (SPA) — loaded from web/index.html
# =============================================================================
...
def _load_spa() -> str:
    ...
    return (
        ...
        "<h1>StreamHub</h1><p>web/index.html missing. Place the SPA next to api.py.</p>"
        "<p><a href='/docs' style='color:#2dd4bf'>API Docs</a></p></body></html>"
    )

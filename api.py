...
let MSTATE={id:'',vid:'',title:'',artist:'',thumb:'',audioUrl:null,lines:[],queue:[],qIdx:0,loop:'off',shuffle:false,_lrcIdx:-1,_playToken:0};
...
async function musicPlayPage(rawId){
  ...
  root.innerHTML=`<div class="sm-player">
    ...
    <div class="m-lyrics">
      <div class="m-lyrics-head"><h3>Lyrics</h3><span class="tag" id="lrc-tag"></span></div>

...
async def health():
    return {"ok": True, "version": "5.15.1", "providers": ["tmdb", "vidsrc", "4khdhub", "hubcloud", "ytmusic", "jiosaavn", "deezer", "piped", "lrclib", "moviebox-api", "netmirror", "vixsrc"]}
...
async def anime_stream(
    ...
    if not stream and hash:
        ...
        stream = f"https://www.hindianime.site/api/proxy/master.m3u8?hash={hash}"

...
async def health():
    return {"ok": True, "version": "5.40.0", "creator": "shawon", "providers": ["hindianime", "ytmusic", "deezer", "jiosaavn", "tmdb"]}
...
# FastMusic / ClulesVibe — separate module (edit fastmusic.py to change music APIs)
try:
    from fastmusic import router as fastmusic_router
    app.include_router(fastmusic_router)
except Exception as _fm_err:
    import sys
    print("fastmusic router load failed:", _fm_err, file=sys.stderr)
